...
<LINK 
href="/sflatsys/admin/images/syscome.files/Admin.css" rel=stylesheet>
<SCRIPT language=javascript src="/sflatsys/admin/images/syscome.files/Admin.js"></SCRIPT>
...
if(filename!=null)
{
 ...
 txt.src="/sflatsys/upfile/<%=filename%>";
 popclose();
 </script>
 <%} %>
<form action="/sflatsys/sflatsys?ac=uploadimg2" enctype="multipart/form-data" name="f1" method="post">
...
if(suc!=null)
{
 %>
 alert("操作成功");
  parent.location.replace("/sflatsys/admin/kcfiles.jsp");
 <%}%>
 </script>
