...
function uploadimg()
{
pop("/sflatsys/js/uploadimg.jsp","上传图片",300,77)
}

function uploadimg2()
{
pop("/sflatsys/js/uploadimg2.jsp","上传图片",300,77)
}

function uploadimg3()
{
pop("/sflatsys/js/uploadimg3.jsp","上传图片",300,77)
}

function uploadimg4()
{
pop("/sflatsys/js/uploadimg4.jsp","上传图片",300,77)
}


function uploadimg5()
{
pop("/sflatsys/js/uploadimg5.jsp","上传图片",300,77)
}


function uploaddoc()
{
pop("/sflatsys/js/uploaddoc.jsp","docupload",300,77)
}
...
build:function(){
   ...
   var close='<img id="dialogBoxClose" title="关闭" src=/sflatsys/js/dialogclose.gif  />';
