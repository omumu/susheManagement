    ...
    <td width="182" valign="top"><div id="container">
      ...
      <div class="content" style="display: ">
        ...
        <ul class="MM">
          ...
          <li><a href="caiwcx.jsp" target="main">收缴员用户管理</a></li>
      ...
      <div class="content" style="display: ">
        ...
        <ul class="MM">
          ...
          <li><a href="nmixinfocx.jsp" target="main">新闻信息查看</a></li>
        ...
        <li><a href="sgrzinfocx.jsp" target="main">入住信息查看</a></li>  
            <li><a href="lsinfocx.jsp" target="main">历史入住信息</a></li>
        </ul>
      </div>
